...
import { WaveManager, type Difficulty } from '@/defense/WaveManager';
...
export class GameScene extends Phaser.Scene {
  ...
  private kingdomsSettings: { scenario: string; difficulty: Difficulty; speed: number } | null = null;
  ...
  init(data: {
    ...
    kingdomsSettings?: { scenario: string; difficulty: Difficulty; speed: number };
  }): void {
